...
- Variant-specific content: same cases per trial, numeric English evidence for original absent target, raw rejected expression.
- Model-call policy: `TEN_PREDETERMINED_TRIALS; ENGLISH_PRE_REVIEW_SUPPRESSION`.
