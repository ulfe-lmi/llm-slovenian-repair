...
- Question: How did the separately sampled validator classify frozen first-pass proposals?
- Authorized change: low-thinking review plus a frozen validator pass
- Status: `COMPLETED`; an old `RUNNING` marker is not completion.
- Private logical root: `experiments/low-plus-validator-20260909.eKAYe6`; native path and payloads are not published.

## Configuration projection

- Variant-specific wire/content boundary: The validator driver reuses caller-supplied frozen first-stage proposals and sends validator calls only. See [configuration](../configs/low-plus-validator.json) fields historical_wire_keys, historical_content, and model_call_policy; no later variant's content is inferred.
...
- [Configuration](../configs/low-plus-validator.json)
