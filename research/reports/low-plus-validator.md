...
- Variant-specific content: frozen first-stage proposal, original sentence, selected target, resulting sentence.
- Model-call policy: `REUSE_FROZEN_FIRST_STAGE; VALIDATOR_CALLS_ONLY`.
