...
- Variant-specific wire/content boundary: The early direct family sends one selected-target review with mechanical-only acceptance and no later policy. See [configuration](../configs/low-thinking-mechanical.json) fields historical_wire_keys, historical_content, and model_call_policy; no later variant's content is inferred.
