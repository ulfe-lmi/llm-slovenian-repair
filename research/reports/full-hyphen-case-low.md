...
- Variant-specific content: sentence, hyphen-space target, one-way initial-case adjustment, raw rejected word.
- Model-call policy: `NO_ENGLISH_POLICY; WORD_ONLY_RETRY; ONE_WAY_INITIAL_CASE`.
