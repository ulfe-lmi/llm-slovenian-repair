...
- Variant-specific wire/content boundary: The uncapped campaign records caller-owned phase/worker requests and preserves the human pause. See [configuration](../configs/large-evaluation-uncapped.json) fields historical_wire_keys, historical_content, and model_call_policy; no later variant's content is inferred.
