...
## Identity
004-a, numeric objective 004, DEMONSTRATOR. CREATE_NEW_PR after reconciliation;
if interrupted after PR creation, adopt that same verified branch/PR.

## Provenance
H: PLAN.md §6; D02. A: ARCHITECTURE.md §§8.1,8.2.
...
## Governance
Relevant invariants: LR-008, LR-013, LR-014. Read C-READ-01 compact sequence,
...
Deliver source manifests and miniature synthetic corpus as one separately reviewable seam: Record provenance, normalization, license-status and completeness/cutoff; fixture counts explicitly synthetic.
Prerequisites: 003.
Confirm their actual contracts/evidence, not just existence of earlier draft files.

## Scope
Primary boundary: source manifest schema and synthetic corpus fixtures. Record normalization, release, rights status, checksum, cutoff, annotation and denominator completeness; label every miniature count synthetic.
...
## Non-goals
Do not claim corpus release access or publish copied corpus text. Do not absorb adjacent objectives or change human product intent.

## Files and boundaries
Inspect source manifest schema and synthetic corpus fixtures; existing interfaces supplied by prerequisites; relevant compact
...
## Requirements
1. Record normalization, release, rights status, checksum, cutoff, annotation and denominator completeness; label every miniature count synthetic.
2. Record provenance, normalization, license-status and completeness/cutoff; fixture counts explicitly synthetic.
3. Preserve LR-008, LR-013, LR-014 across the edge cases below. Bound resources and
...
2. Round-trip manifests deterministically; reject missing rights/status, inconsistent checksum and censored absence presented as EXACT zero.
...
## Verification
Focused future test target: `uv run pytest tests/contract/test_objective_004.py -q`.
...
Negative and boundary proof: Round-trip manifests deterministically; reject missing rights/status, inconsistent checksum and censored absence presented as EXACT zero.
