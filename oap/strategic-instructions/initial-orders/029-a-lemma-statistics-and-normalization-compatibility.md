# Work order 029-a — Lemma statistics and normalization compatibility
...
{
  "id": "029-a",
  "title": "Lemma statistics and normalization compatibility",
  "objective": "029",
  "status": "DRAFT UNTIL STRATEGIC RECONCILIATION",
  "phase": "MVP",
  ...
  "branch": "oap/029-lemma-statistics-and-normalization-compatibility",
  ...
  "provenance": [
    {
      "kind": "H",
      "reference": "PLAN.md §§6.2–6.3, 7.3; M02"
    },
    {
      "kind": "A",
      "reference": "ARCHITECTURE.md §§8.1,9"
    }
  ],
...
## Identity
029-a, numeric objective 029, MVP. CREATE_NEW_PR after reconciliation;
if interrupted after PR creation, adopt that same verified branch/PR.

## Provenance
H: PLAN.md §§6.2–6.3, 7.3; M02. A: ARCHITECTURE.md §§8.1,9.
...
## Governance
Relevant invariants: LR-008, LR-009. Read C-READ-01 compact sequence,
...
Deliver lemma statistics and normalization compatibility as one separately reviewable seam: Source-consistent lemma evidence; do not reconstruct complete lemma distributions from censored forms.
Prerequisites: 008, 027.
Confirm their actual contracts/evidence, not just existence of earlier draft files.

## Scope
Primary boundary: lemma evidence compatibility. Preserve source/tagger/normalization identities and scope while joining lemma evidence; keep incomplete form aggregation marked incomplete.
...
## Non-goals
No retrospective fabricated corpus counts or merging incompatible source statistics. Do not absorb adjacent objectives or change human product intent.

## Files and boundaries
Inspect lemma evidence compatibility; existing interfaces supplied by prerequisites; relevant compact
...
## Requirements
1. Preserve source/tagger/normalization identities and scope while joining lemma evidence; keep incomplete form aggregation marked incomplete.
2. Source-consistent lemma evidence; do not reconstruct complete lemma distributions from censored forms.
3. Preserve LR-008, LR-009 across the edge cases below. Bound resources and
...
2. Test compatible and mismatched normalization, multi-lemma ambiguity and censored forms; reject invented complete lemma denominator from retained entries.
...
## Verification
Focused future test target: `uv run pytest tests/contract/test_objective_029.py -q`.
...
Negative and boundary proof: Test compatible and mismatched normalization, multi-lemma ambiguity and censored forms; reject invented complete lemma denominator from retained entries.
