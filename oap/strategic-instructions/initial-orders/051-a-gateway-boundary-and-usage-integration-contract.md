# Work order 051-a — Gateway boundary and usage integration contract
...
{
  "id": "051-a",
  "title": "Gateway boundary and usage integration contract",
  "objective": "051",
  "status": "DRAFT UNTIL STRATEGIC RECONCILIATION",
  "phase": "SERVICE",
  ...
  "branch": "oap/051-gateway-boundary-and-usage-integration-contract",
  ...
  "provenance": [
    {
      "kind": "H",
      "reference": "PLAN.md §11.2; S03"
    },
    {
      "kind": "A",
      "reference": "ARCHITECTURE.md §§4,13"
    }
  ],
...
## Identity
051-a, numeric objective 051, SERVICE. CREATE_NEW_PR after reconciliation;
if interrupted after PR creation, adopt that same verified branch/PR.

## Provenance
H: PLAN.md §11.2; S03. A: ARCHITECTURE.md §§4,13.
...
## Governance
Relevant invariants: LR-005, LR-012, LR-013, LR-014. Read C-READ-01 compact sequence,
...
Deliver gateway boundary and usage integration contract as one separately reviewable seam: Define public auth/quota ownership and private review accounting; no unauthorized edits to gateway or local-coding repositories.
Prerequisites: 037, 041, 043.
Confirm their actual contracts/evidence, not just existence of earlier draft files.

## Scope
Primary boundary: gateway integration contract and accounting. Define allowed main route/public authentication/quotas and private review cost visibility with internal control that callers cannot forge.
...
## Non-goals
No unauthorized edits to gateway/local-coding repositories, public exposure or copied credentials. Do not absorb adjacent objectives or change human product intent.

## Files and boundaries
Inspect gateway integration contract and accounting; existing interfaces supplied by prerequisites; relevant compact
...
## Requirements
1. Define allowed main route/public authentication/quotas and private review cost visibility with internal control that callers cannot forge.
2. Define public auth/quota ownership and private review accounting; no unauthorized edits to gateway or local-coding repositories.
3. Preserve LR-005, LR-012, LR-013, LR-014 across the edge cases below. Bound resources and
...
2. Fake gateway boundary verifies permitted envelopes and rejects bypass/caller endpoint misuse; record real neighbor integration as separately authorized/unverified.
...
## Verification
Focused future test target: `uv run pytest tests/contract/test_objective_051.py -q`.
...
Negative and boundary proof: Fake gateway boundary verifies permitted envelopes and rejects bypass/caller endpoint misuse; record real neighbor integration as separately authorized/unverified.
