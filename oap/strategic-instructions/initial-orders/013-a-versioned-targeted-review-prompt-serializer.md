# Work order 013-a — Versioned targeted-review prompt serializer
...
{
  "id": "013-a",
  "title": "Versioned targeted-review prompt serializer",
  "objective": "013",
  "status": "DRAFT UNTIL STRATEGIC RECONCILIATION",
  "phase": "DEMONSTRATOR",
  ...
  "branch": "oap/013-versioned-targeted-review-prompt-serializer",
  ...
  "provenance": [
    {
      "kind": "H",
      "reference": "PLAN.md §8.1–8.3; D05"
    },
    {
      "kind": "A",
      "reference": "ARCHITECTURE.md §§10.1,10.2"
    }
  ],
...
## Identity
013-a, numeric objective 013, DEMONSTRATOR. CREATE_NEW_PR after reconciliation;
if interrupted after PR creation, adopt that same verified branch/PR.

## Provenance
H: PLAN.md §8.1–8.3; D05. A: ARCHITECTURE.md §§10.1,10.2.
...
## Governance
Relevant invariants: LR-003, LR-004, LR-005, LR-006. Read C-READ-01 compact sequence,
...
Deliver versioned targeted-review prompt serializer as one separately reviewable seam: Preserve the agreed question and keep/wider-edit options; unambiguous repeated occurrence; no corpus candidates or main history.
Prerequisites: 003, 009.
Confirm their actual contracts/evidence, not just existence of earlier draft files.

## Scope
Primary boundary: prompts.py serializer. Preserve the exact Slovenian suitability question, keep and wider-edit refusal; serialize unique occurrence using before_target/target/after_target and bounded sentence neighbors.
...
## Non-goals
No whole-answer proofreading prompt, extra IDs or real review inference. Do not absorb adjacent objectives or change human product intent.

## Files and boundaries
Inspect prompts.py serializer; existing interfaces supplied by prerequisites; relevant compact
...
## Requirements
1. Preserve the exact Slovenian suitability question, keep and wider-edit refusal; serialize unique occurrence using before_target/target/after_target and bounded sentence neighbors.
2. Preserve the agreed question and keep/wider-edit options; unambiguous repeated occurrence; no corpus candidates or main history.
3. Preserve LR-003, LR-004, LR-005, LR-006 across the edge cases below. Bound resources and
...
2. Capture serialized synthetic material with repeated targets and embedded hostile instructions; assert no corpus candidate ranking, main history, tools or constitution.
...
## Verification
Focused future test target: `uv run pytest tests/contract/test_objective_013.py -q`.
...
Negative and boundary proof: Capture serialized synthetic material with repeated targets and embedded hostile instructions; assert no corpus candidate ranking, main history, tools or constitution.
