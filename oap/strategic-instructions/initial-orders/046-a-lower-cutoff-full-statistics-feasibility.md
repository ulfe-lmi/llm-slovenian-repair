# Work order 046-a — Lower-cutoff/full-statistics feasibility
...
{
  "id": "046-a",
  "title": "Lower-cutoff/full-statistics feasibility",
  "objective": "046",
  "status": "DRAFT UNTIL STRATEGIC RECONCILIATION",
  "phase": "SERVICE",
  ...
  "branch": "oap/046-lower-cutoff-full-statistics-feasibility",
...
## Identity
046-a, numeric objective 046, SERVICE. CREATE_NEW_PR after reconciliation;
if interrupted after PR creation, adopt that same verified branch/PR.

## Provenance
H: PLAN.md §6.2; S02. A: ARCHITECTURE.md §§8.1,8.2.
...
Deliver lower-cutoff/full-statistics feasibility as one separately reviewable seam: Rights-aware reproducible plan or bounded importer improvement; unavailable data recorded honestly; no fabricated complete counts.
Prerequisites: 005, 007, 008, 034.
Confirm their actual contracts/evidence, not just existence of earlier draft files.

## Scope
Primary boundary: lower-cutoff/full-statistics feasibility. Determine whether permitted fuller counts resolve censored/denominator limitations; define deterministic bounded import extension with clear scope/completeness metadata.
...
## Non-goals
No scraping around rights, assuming every release shares cutoff or treating unavailable evidence as neutral approval. Do not absorb adjacent objectives or change human product intent.

## Files and boundaries
Inspect lower-cutoff/full-statistics feasibility; existing interfaces supplied by prerequisites; relevant compact
...
## Requirements
1. Determine whether permitted fuller counts resolve censored/denominator limitations; define deterministic bounded import extension with clear scope/completeness metadata.
2. Rights-aware reproducible plan or bounded importer improvement; unavailable data recorded honestly; no fabricated complete counts.
...
2. Prove exact zero only under complete source and compare ratio bounds correctly; report unavailable access or nonadoption without fabricating full context mass.
...
## Verification
Focused future test target: `uv run pytest tests/contract/test_objective_046.py -q`.
...
Negative and boundary proof: Prove exact zero only under complete source and compare ratio bounds correctly; report unavailable access or nonadoption without fabricating full context mass.
